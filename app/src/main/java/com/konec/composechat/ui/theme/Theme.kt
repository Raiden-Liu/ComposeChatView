package com.konec.composechat.ui.theme
...
@Composable
fun ComposeChatTheme(theme: ComposeChatTheme.Theme = ComposeChatTheme.Theme.Light, content: @Composable() () -> Unit) {
    val targetColors = when (theme) {
        ComposeChatTheme.Theme.Light -> LightColorPalette
        ComposeChatTheme.Theme.Dark -> DarkColorPalette
        ComposeChatTheme.Theme.NewYear -> NewYearColorPalette
    }
